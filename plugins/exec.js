...
let peli = await (await fetch('https://telegra.ph/file/a24b000250cb118cd1e97.jpg')).buffer()
let ye = await (await fetch('https://telegra.ph/file/a24b000250cb118cd1e97.jpg')).buffer()
  let _return
  let _syntax = ''
...
orderTitle: 'B',
sellerJid: '62895336282144@s.whatsapp.net',
thumbnail: ye
