...
let handler = async function (m, { text, usedPrefix }) {
  ...
  let pantek = 'https://telegra.ph/file/a24b000250cb118cd1e97.jpg'
  ...
  if (age > 24) throw 'Maaf, Anda terlalu tua.\n*Minimal umur 24 ke Atas*'
  user.name = name
